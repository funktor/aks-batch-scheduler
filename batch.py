...
class Batch:
    ...
    def print_task_output(self, 
        ...
        for task in tasks:
            ...
            stream = self.batch_service_client.file.get_from_task(
                job_id, task.id, constants.STANDARD_OUT_FILE_NAME)

            file_text = _read_stream_as_string(stream, text_encoding)
